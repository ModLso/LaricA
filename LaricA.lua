...
if result.sender_user_id_ == tonumber(18781544301100) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
os.execute('wget https://raw.githubusercontent.com/MALATHSOURCE/LaricA/master/LaricA.lua')
os.execute('wget https://raw.githubusercontent.com/MALATHSOURCE/LaricA/master/start.lua')
dofile('LaricA.lua')  
return false
end
if text == "راسلني" then
